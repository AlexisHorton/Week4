...
namespace InterfaceDemp
{
    ...
    class LibraryBook : IRentable
    {
        ...
        public DateTime? DueDate;       //changes to slightly diff type, made it a nullable type| can return date, time, or null
        ...
        {
            return $"Library Book: Title {Title} by Author {Author} due on {DueDate}.";
        }
    }
    ...
    class DVD : IRentable
    {
        ...
        public override string ToString()
        {
            return $"DVD: Title {Title} by Author {Director} due on {DueBackOn}.";
        }
    }
